...
<main>
    ...
    <div id="about" class="tab-content active">
        ...
        <div class="hero">
            ...
            <p>I build AI systems that make information more accessible — through better language understanding, reliable agents, and evaluation frameworks that actually measure what matters. My focus is on making <strong>agentic AI</strong> not just capable, but genuinely trustworthy.</p>
